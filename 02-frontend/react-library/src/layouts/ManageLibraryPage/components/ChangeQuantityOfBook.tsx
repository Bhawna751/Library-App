...
export const ChangeQuantityOfBook: React.FC<{book: BookModel, deleteBook:any}> = (props, key) => {
    ...
    async function increaseQuantity(){
        const url = `http://localhost8080/api/admin/secure/increase/book/quantity/?bookId=${props.book?.id}`;
    ...
    async function decreaseQuantity(){
        const url = `http://localhost8080/api/admin/secure/decrease/book/quantity/?bookId=${props.book?.id}`;
        const requestOptions = {
            method:'PUT',
            headers:{
                Authorization: `Bearer ${authState?.accessToken?.accessToken}`,
    ...
    async function deleteBook(){
        const url = `http://localhost8080/api/admin/secure/delete/book/?bookId=${props.book?.id}`;
        const requestOptions = {
            method:'DELETE',
            headers:{
                Authorization: `Bearer ${authState?.accessToken?.accessToken}`,
            ...
            <div className="row g-0">
                ...
                <div className="col-md-6">
                    <div className="card-body">
                        ...
                        <p className="card">{props.book.description}</p>
                    </div>
                </div>
