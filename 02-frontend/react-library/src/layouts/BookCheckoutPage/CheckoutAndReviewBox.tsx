...
export const CheckoutAndReviewBox: React.FC<{book:BookModel | undefined, mobile: boolean,
    ...
    function buttonRender(){
        if(props.isAuthenticated){
            if(!props.isCheckedOut && props.currentLoansCount < 5){
                return (<button onClick={()=>props.checkoutBook} className="btn tbn-success btn-lg">Checkout</button>)
    ...
    return(
        <div className={props.mobile ? 'card d-flex mt-5' : 'container d-flex mb-5'}>
            <div className="mt-3">
                <p>
